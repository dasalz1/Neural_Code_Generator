...
def main(args):
	...
	if torch.cuda.device_count() > 1:
		...
		trg_word_prj = torch.nn.DataParallel(trg_word_prj, device_ids=list(range(args.num_embed_devices if args.embed_device is not None else 0, torch.cuda.device_count())))
